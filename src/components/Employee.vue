...
<template>
    <div :class="`flex flex-col max-w-64 p-4 gap-y-1 bg-white border border-gray-200 rounded-lg shadow hover:cursor-pointer ${background_color}`">
        ...
        <div class="flex flex-row flex-wrap gap-1 justify-center text-sm">
            <span :class="`flex text-center px-1.5 rounded-2xl border-2 border-gray-800 border-opacity-60 ${background_text}`">{{employee["Department"]}}</span>
            <span :class="`flex text-center px-1.5 rounded-2xl border-2 border-gray-800 border-opacity-60 ${background_text}`">Level {{employee["level"]}}</span>
