...
<template>
    <div class="flex flex-col gap-y-16">
        ...
        <div :class="`justify-center m-auto flex flex-col w-48 h-56 p-4 gap-y-2 bg-white border border-gray-200 rounded-lg shadow hover:cursor-pointer ${background_color}`" @click="expanded = !expanded">
            ...
            <div class="flex flex-row flex-wrap gap-1 mb-0 m-auto text-sm">
                ...
                <span :class="`flex text-center px-1.5 rounded-2xl ${background_text}`">Level {{props.employee.current["level"]}}</span>
                <div :class="`flex flex-row px-1.5 gap-x-1 rounded-2xl ${background_text}`">
