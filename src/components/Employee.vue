...
<template>
    ...
    <Transition enter-from-class="transition-all opacity-0 duration-300 ease" enter-to-class="transition-all opacity-1 duration-300 ease" leave-active-class="transition-all opacity-1 duration-300 ease" leave-to-class="transition-all opacity-0 duration-300 ease">
        <div :class="`flex flex-col w-60 h-80 p-4 gap-y-2 bg-white border border-gray-200 rounded-lg shadow hover:cursor-pointer ${background_color}`" @click="expanded = !expanded">
